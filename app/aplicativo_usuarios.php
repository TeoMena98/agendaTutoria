...
use Illuminate\Foundation\Auth\aplicativo_usuarios as Authenticatable;

class aplicativo_usuarios extends Authenticatable
{
    use Notifiable;
     ...
     */
    protected $fillable = [
        'correo', 'nombre', 'pass', 'documento', 'telefono', 'id_rol'
    ];
